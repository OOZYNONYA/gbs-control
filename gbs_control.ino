...
#define USE_OLD_OLED_MENU 0 
#define USE_LCD_MENU 1       // do not turn on multiple menus simultaneously.      
...
extern volatile int LCD_main_pointer; // volatile vars change done with ISR //default is 0
...
#endif
#if USE_LCD_MENU //LCD loop starts here
//LCD LOOP
